    ...
    <div className="organizer-profile">
      <div className="profile-header">
        ...
        <div className="profile-info">
          <h2>{user?.username}</h2>
          <p>{user?.email}</p>
          <span className="role-badge">Event Organizer</span>
        </div>
      </div>
      ...
      <div className="profile-sections">
        ...
        <div className="section">
          ...
          <Link to="/profile/edit" state={{ from: '/organizer/profile' }} className="btn">Change Password</Link>
          <Link to="/organizer/notifications" className="btn">Notification Settings</Link>
        </div>
      </div>
